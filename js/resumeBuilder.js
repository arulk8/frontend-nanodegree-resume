...
var bio = {
        ...
        "display": function () {
                ...
                $("#topContacts,#footerContacts").append(formattedmobile, formattedgithub, formattedemail, formattedlocation);
...
var education = {
        ...
        "display": function () {
                ...
                education.schools.forEach(function (i) {
                        ...
                        for (var j = 0; j < i.majors.length; j++) {
                                var formattedschoolMajor = HTMLschoolMajor.replace("%data%", i.majors[j]);
